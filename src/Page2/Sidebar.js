...
function Sidebar() {
    ...
    <div class="flex flex-col justify-between flex-1 mt-6">
        <nav class="-mx-3 space-y-6 ">
            <div class="space-y-3 ">
                ...
                <a class="flex items-center px-3 py-2 transition-colors duration-300 transform rounded-lg text-gray-200 hover:bg-gray-800 hover:text-gray-200" href="#">
  ...
  <div class="absolute bottom-0 text-white left-0 h-16 w-16 mx-2 text-xs font-medium">Help Contact Us</div>
  </div>
